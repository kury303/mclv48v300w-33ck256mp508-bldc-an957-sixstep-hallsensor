...
## 1. INTRODUCTION
This document describes the setup requirements for driving a Brushless DC (BLDC) Motor using six-step commutation with Hall Sensor feedback on the hardware platform [EV18H47A](https://www.microchip.com/en-us/development-tool/ev18h47a) "MCLV-48V-300W Development Board"  and [EV62P66A](https://www.microchip.com/en-us/development-tool/ev62p66a) "dsPIC33CK256MP508 Motor Control Dual In-line Module (DIM)".
...
- Navigate to the [main page of this repository](https://github.com/microchip-pic-avr-solutions/mclv-48v-300w-an957-dsPIC33CK256MP508 ) and 
...
4. Connect the motor's hall sensor wires in the specified order, as shown in the following figures, to HA, HB, and HC of the **connector J5** provided on the development board. Be sure to refer to the connection diagram corresponding to the motor under test.
     ...
     <p align="left" >
      <img  src="images/hallsensorconnection.png" width="600"></p>
...
3. Open <code>**mc1_user_params.h** </code> (**bldc.X > Header Files**) in the project **bldc.X.**  
